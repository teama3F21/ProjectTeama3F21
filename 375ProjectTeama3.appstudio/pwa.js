...
const cacheName = '_75ProjectTeama2-2021-11-02 13:08:28.141004'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, '_75ProjectTeama2'.length) === '_75ProjectTeama2') {
